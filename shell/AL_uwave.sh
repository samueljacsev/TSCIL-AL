...
python main_tune.py --data uwave --encoder CNN --agent ASER --norm BN --sampler kmeans_ppp & wait;\
...
python main_tune.py --data uwave --encoder CNN --agent ER --norm BN --sampler kmeans_ppp & wait;\
