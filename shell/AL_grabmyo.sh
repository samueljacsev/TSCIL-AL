...
python main_tune.py --data grabmyo --encoder CNN --agent ASER --norm BN --sampler coreset & wait;\
python main_tune.py --data grabmyo --encoder CNN --agent ASER --norm BN --sampler kmeans_ppp & wait;\
...
python main_tune.py --data grabmyo --encoder CNN --agent ER --norm BN --sampler coreset & wait;\
python main_tune.py --data grabmyo --encoder CNN --agent ER --norm BN --sampler kmeans_ppp & wait;\
